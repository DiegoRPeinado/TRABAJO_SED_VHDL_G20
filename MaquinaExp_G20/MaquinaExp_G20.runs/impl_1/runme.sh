...
HD_PWD='C:/Users/diego/OneDrive/Documentos/TRABAJO_SED_VHDL_G20/MaquinaExp_G20/MaquinaExp_G20.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAQ_EXP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAQ_EXP.tcl -notrace

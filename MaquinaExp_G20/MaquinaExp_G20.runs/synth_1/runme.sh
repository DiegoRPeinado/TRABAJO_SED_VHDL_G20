...
HD_PWD='C:/Users/diego/OneDrive/Documentos/TRABAJO_SED_VHDL_G20/MaquinaExp_G20/MaquinaExp_G20.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAQ_EXP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAQ_EXP.tcl
